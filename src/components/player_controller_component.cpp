...
{
    NotificationManager::Get()->AddListener(this, NotificationType::PlayerHit);
...
{
    NotificationManager::Get()->RemoveListener(this, NotificationType::PlayerHit);
}
...
void PlayerControllerComponent::OnPlayerHit(PlayerHitNotification* playerHit)
{
    if (!isImmortal)
    {
        SetLife(life - playerHit->hitAmount);
        isImmortal = true;
...
void PlayerControllerComponent::OnNotify(NotificationType type, Notification* notification)
{
    switch (type)
    {
    case NotificationType::PlayerHit: OnPlayerHit((PlayerHitNotification*)notification); break;
    }
}